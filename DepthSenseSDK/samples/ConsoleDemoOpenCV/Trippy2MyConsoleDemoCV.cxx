  ...
  //printf("Z#%u: %d\n",g_dFrames,data.vertices.size());
    ...
    */
    ...
    //printf("wrote files");
      char filename[100];
      g_fTime = clock();
      sprintf(filename,"./d/df%d.%d.jpg",(int)(g_fTime/CLOCKS_PER_SEC), (int)(g_fTime%CLOCKS_PER_SEC));
      cvSaveImage(filename,g_depthImage);
      sprintf(filename,"./v/vf%d.%d.jpg",(int)(g_fTime/CLOCKS_PER_SEC), (int)(g_fTime%CLOCKS_PER_SEC));
      //if (g_saveImageFlag) 
